...
Supports two scoring systems:
  ...
  2. Ashta Koota (36 points, 8 factors) — original the tradition system

References:
  - "Vedic Astrology: An Integrated Approach" by P.V.R. Narasimha Rao
  - Original standard binary (Ashta Koota: format string at 0x591a3c,
...
def gunanka_level(score: float) -> str:
    ...
    Matches the original the tradition format string:
...
# ═══════════════════════════════════════════════════════════════════════════════
# Ashta Koota (8 factors, 36 points) — used by original the tradition
# ═══════════════════════════════════════════════════════════════════════════════
