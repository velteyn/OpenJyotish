...
Primary source: copy from an existing the tradition installation.
The astro.com server blocks direct downloads (HTTP 404).

If you have the original the tradition installed, point to its ephe directory.
...
def main():
    ...
    # Try common the tradition install locations
    locations = [
        "C:/Program Files/the tradition/jhcore/ephe",
        "C:/Projects/jhora/jhcore/ephe",
        os.path.expanduser("~/jhora/jhcore/ephe"),
        "<local>/projects/Reversing/Jhora/jhcore/ephe",
    ]
    ...
    print("Options:")
    print("  1. Copy from original the tradition: jhora/download_ephe.py /path/to/jhora/jhcore/ephe")
