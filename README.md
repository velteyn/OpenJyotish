...
28-section JSON API for AI agents (+ JSON-LD)  |  1681 tests  |  GPL v3.0
```
...
|---------|-------------|
| `chart` | Rasi chart + planets (combustion + gandanta flags) + upagrahas + outer planets (`--nodes` mean/true, `--chalit` + `--bhava-method` default/sripati) |
...
Matchmaking (10 Porutham + Ashta Koota 36pt) · Muhurta · Monthly calendar · Choghadiya · Hora · Prasna
